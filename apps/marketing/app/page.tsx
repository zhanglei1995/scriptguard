...
const steps = [
  {
    ...
    description: 'Add ScriptGuard from the Chrome Web Store in seconds.',
  },
  {
    step: '2',
    title: 'Auto-detect scripts',
    description: 'ScriptGuard automatically detects and catalogs all your userscripts.',
  },
  {
    step: '3',
    title: 'Stay protected',
    description: 'Get real-time monitoring, health checks, and instant alerts.',
  },
];
    ...
    <>
        ...
        <div className="section-container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="section-subtitle">
              ScriptGuard keeps your userscripts running smoothly with powerful monitoring and
              management tools.
            </p>
          </div>
      ...
      <section className="border-t border-gray-200 bg-gray-50 py-24 dark:border-gray-800 dark:bg-gray-900/50 sm:py-32">
        <div className="section-container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="section-subtitle">
              Three simple steps to a healthier userscript experience.
            </p>
          </div>
          <div className="mx-auto mt-16 grid max-w-5xl gap-12 lg:grid-cols-3">
            {steps.map((step) => (
              <div key={step.step} className="text-center">
                ...
                <h3 className="mt-6 text-lg font-semibold text-dark dark:text-white">
                  {step.title}
                </h3>
            ...
            {[
              {
                name: 'Alex',
                role: 'Developer',
                text: 'Finally I can monitor all my Tampermonkey scripts in one place. Great extension!',
              },
              {
                name: 'Sarah',
                role: 'Power User',
                text: 'The health check feature is a game changer. I know instantly when something breaks.',
              },
              {
                name: 'Mike',
                role: 'Script Author',
                text: 'I use ScriptGuard to track adoption of my userscripts. Super useful analytics.',
              },
            ].map((t) => (
              <div
                key={t.name}
                className="rounded-2xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-dark"
              >
      ...
      <section className="py-24 sm:py-32">
        <div className="section-container text-center">
          ...
          <p className="section-subtitle">
            Install ScriptGuard and take control of your userscripts today.
          </p>
          <div className="mt-10">
            <a
              href="https://chromewebstore.google.com/detail/scriptguard"
