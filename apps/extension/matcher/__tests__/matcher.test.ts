...
describe('matcher/index', () => {
  describe('matchScript', () => {
    ...
    it('matches regex pattern', () => {
      expect(matchScript('https://example.com/orders/123', ['/example\.com\/orders\/\\d+/'])).toBe(true)
      expect(matchScript('https://example.com/orders/abc', ['/example\.com\/orders\/\\d+/'])).toBe(false)
    })
