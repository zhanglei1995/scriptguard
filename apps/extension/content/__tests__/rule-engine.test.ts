...
describe('rule-engine', () => {
  ...
  describe('selector_exists', () => {
    it('passes when element exists', () => {
      ...
      const rules: CheckRule[] = [
        { id: 'r1', name: 'exists', type: 'selector_exists', config: { selector: '#target' }, required: true },
      ]
    ...
    it('fails when element does not exist', () => {
      ...
      const rules: CheckRule[] = [
        { id: 'r1', name: 'exists', type: 'selector_exists', config: { selector: '#missing' }, required: true },
      ]
  ...
  describe('selector_visible', () => {
    it('passes when element has dimensions', () => {
      ...
      const rules: CheckRule[] = [
        { id: 'r1', name: 'visible', type: 'selector_visible', config: { selector: '#box' }, required: true },
      ]
    ...
    it('fails when element does not exist', () => {
      ...
      const rules: CheckRule[] = [
        { id: 'r1', name: 'visible', type: 'selector_visible', config: { selector: '#missing' }, required: true },
      ]
  ...
  describe('url_match', () => {
    it('passes with glob pattern', () => {
      const rules: CheckRule[] = [
        { id: 'r1', name: 'url', type: 'url_match', config: { pattern: 'https://example.com/*' }, required: true },
      ]
    ...
    it('fails when URL does not match', () => {
      const rules: CheckRule[] = [
        { id: 'r1', name: 'url', type: 'url_match', config: { pattern: 'https://other.com/*' }, required: true },
      ]
    ...
    it('passes with regex pattern', () => {
      const rules: CheckRule[] = [
        { id: 'r1', name: 'url', type: 'url_match', config: { pattern: '/example\\.com/' }, required: true },
      ]
    ...
    it('returns false for invalid regex', () => {
      const rules: CheckRule[] = [
        { id: 'r1', name: 'url', type: 'url_match', config: { pattern: '[invalid' }, required: true },
      ]
  ...
  describe('multi-rule combinations', () => {
    it('healthy when all rules pass', () => {
      ...
      const rules: CheckRule[] = [
        ...
        { id: 'r2', name: 'url', type: 'url_match', config: { pattern: 'https://example.com/*' }, required: true },
      ]
    ...
    it('degraded when optional rule fails', () => {
      ...
      const rules: CheckRule[] = [
        { id: 'r1', name: 'exists', type: 'selector_exists', config: { selector: '#app' }, required: true },
        { id: 'r2', name: 'missing-opt', type: 'selector_exists', config: { selector: '#optional' }, required: false },
      ]
