    ...
    >
      ...
      {status === 'success' && (
        <div className="sg-overlay__actions" style={{ padding: '0 14px 12px' }}>
          <button
            className="sg-overlay__btn sg-overlay__btn--secondary"
      ...
      {status === 'degraded' && (
        <div className="sg-overlay__actions" style={{ padding: '0 14px 12px' }}>
          <button
            className="sg-overlay__btn sg-overlay__btn--primary"
            onClick={() => onDetails(id)}
          >
            详情
          </button>
      ...
      {status === 'failed' && !expanded && (
        <div className="sg-overlay__actions" style={{ padding: '0 14px 12px' }}>
          ...
          {onDisable && (
            <button
              className="sg-overlay__btn sg-overlay__btn--danger"
      ...
      {status === 'failed' && expanded && (
        <div className="sg-overlay__expand">
          <div className="sg-overlay__expand-content">
            ...
            {errorMessage && <div className="sg-overlay__stack">{errorMessage}</div>}
          </div>
...
export class OverlayManager {
  ...
  private handleKeyDown = (e: KeyboardEvent): void => {
    ...
    if (e.key === 'ArrowDown' || e.key === 'ArrowRight') {
      ...
      const id = ids[this.focusedIndex];
      if (id) this.highlightOverlay(id);
