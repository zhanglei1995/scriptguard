...
describe('ScriptsStore', () => {
  ...
  describe('getFilteredScripts', () => {
    beforeEach(() => {
      useScriptsStore
        .getState()
        .createScript({ name: 'A', tags: ['nav'], groupId: 'g1', enabled: true });
      useScriptsStore
        .getState()
        .createScript({ name: 'B', tags: ['footer'], groupId: 'g2', enabled: false });
      useScriptsStore
        .getState()
        .createScript({ name: 'C', tags: ['nav', 'header'], groupId: 'g1', enabled: true });
    });
