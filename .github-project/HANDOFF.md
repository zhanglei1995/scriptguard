...
- **当前进度**：22/55 完成（40.0%）— Sprint 3 完成，Sprint 4 开始
...
| 优先级 | Ticket | 说明 | 依赖 |
|---|---|---|---|
| ⭐⭐⭐ | **SG-028** | Fastify 路由与 Zod 校验 | SG-009 |
| ⭐⭐⭐ | **SG-029** | 认证与 JWT | SG-028 |
| ⭐⭐⭐ | SG-030 | 脚本云端 CRUD API | SG-028, SG-029 |
| ⭐⭐ | SG-031 | 同步协议（增量同步 + 冲突解决）⚠️ | SG-030 |
| ⭐⭐ | SG-032 | 检查规则云端 API | SG-030 |
| ⭐⭐ | SG-033 | 测试调度 API | SG-030 |

> **推荐下一个做 SG-028**（Fastify 路由），开启 Sprint 4 云端服务。
